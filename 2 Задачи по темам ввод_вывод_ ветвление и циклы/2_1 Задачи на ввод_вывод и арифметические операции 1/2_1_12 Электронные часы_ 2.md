...
fn main() {
    ...
    // Parse the input into a total number of seconds
    let total_seconds: u64 = input.trim().parse().expect("Please provide a valid integer");
    ...
    // Output in H:MM:SS format (hours without leading zero, minutes and seconds padded)
