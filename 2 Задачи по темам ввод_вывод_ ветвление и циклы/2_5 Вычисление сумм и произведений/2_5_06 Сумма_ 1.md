...
/// Computes the sum of the series Σ 1⁄i² for i = 1 ..= n,
/// rounds the result to 5 decimal places, and prints it.
fn main() {
    ...
    // Calculate the sum using f64 for floating‑point precision
    let sum: f64 = (1..=n)
        .map(|i| {
            let i_f64 = i as f64;
            1.0 / i_f64.powi(2)
    ...
    // Round to 5 decimal places (the same behavior as Python's round(..., 5))
