...
fn main() {
    ...
    // Чтение строки с 16-ричным числом
    io::stdin().read_line(&mut input).expect("Failed to read line");
    let hex_str = input.trim();

    // Преобразование каждого символа в 4-битное двоичное представление
    let binary_string: String = hex_str
        .chars()
    ...
    // Удаление ведущих нулей
    let result = binary_string.trim_start_matches('0');
    
    // Если число было "0", после trim_start_matches останется пустая строка,
