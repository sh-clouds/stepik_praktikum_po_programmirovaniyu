...
fn main() {
    ...
    let test_cases: usize = it.next().unwrap().parse().unwrap();
    let mut results = Vec::with_capacity(test_cases);
    ...
    for _ in 0..test_cases {
        ...
        let denom = n - 1;
        let threshold = a as f64 + b as f64 / c as f64;
        let mut printed = false;

        for i in 1..denom {
            let d = gcd(i, denom);
            let t = i as f64 + i as f64 / denom as f64;
            if t >= threshold {
                results.push(format!("{} {} {}", i, i / d, denom / d));
                printed = true;
                break;
            }
        }
