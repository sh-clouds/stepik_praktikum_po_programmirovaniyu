...
fn main() {
    ...
    // Parse all numbers, skip the first one, and collect into a vector
    ...
    // If the vector is empty, nothing to process
    if numbers.is_empty() {
        return;
    }
    ...
    // Replace every occurrence of the maximum with the minimum
    ...
    // Print the resulting numbers separated by spaces
    let output = numbers
        .iter()
        .map(|v| v.to_string())
        .collect::<Vec<_>>()
